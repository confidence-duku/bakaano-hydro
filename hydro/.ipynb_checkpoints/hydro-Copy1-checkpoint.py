...
class DeepSTRMM:
    ...
    def __init__(self, project_name, study_area, start_date, end_date, cncoef, rp=None):
        ...
        os.makedirs(f'./{self.project_name}', exist_ok=True)
...
#         dem = dd.download_dem()
        ...
        dem = './common_data/hyd_af_dem_15s.tif'
...
#========================================================================================================================  
    def compute_runoff(self):        
        ...
        filename = f'hydro/{self.project_name}/output_data/wacc_sparse_arrays_{self.project_name}_{year_name}.pkl'
...
#========================================================================================================================  
    ...
    def simulate_streamflow(self, station_name, model_path):
        vdp = PredictDataPreprocessor(self.project_name, self.study_area, self.start_date, self.end_date, '1981-01-01', '1989-12-31')
        ...
        station = extracted_data['runoff_mean'].where(extracted_data['station_name'] == station_name, 
