...
class DEM:
    ...
    def get_dem_data(self):
        ...
        if self.local_data is False:
            if not os.path.exists(self.out_path):
                ...
                with open(local_filename, 'wb') as f:
                    for chunk in response.iter_content(chunk_size=8192):
                        if chunk:
                            f.write(chunk)
                print(f"DEM: downloaded HydroSHEDS archive to {local_filename}")
                ...
                with zipfile.ZipFile(local_filename, 'r') as zip_ref:
                    ...
                    print(f"DEM: extracted archive to {extraction_path}")
                ...
                print(f"DEM: clipped DEM already exists in {self.working_dir}/elevation; skipping download.")
            ...
            try:
                ...
                print(f"DEM local-data configuration error: {e}")
    ...
    def compute_slope_percent_riserun(self):
        ...
        print(f"DEM: slope raster saved to {output_path}")
