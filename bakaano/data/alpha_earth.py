...
class AlphaEarth:
    ...
    def get_alpha_earth(self):
        ...
        if len(missing_bands) == 0:
            print(f"AlphaEarth: all {len(bandlist)} bands already downloaded; skipping download.")
            return
    
        # --- Case 2: Some bands missing → download only missing ones ---
        print(f"AlphaEarth: {len(missing_bands)} bands missing; downloading:")
        ...
        print("AlphaEarth: missing bands downloaded successfully.")
