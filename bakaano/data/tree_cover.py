...
class TreeCover:
    ...
    def _download_tree_cover(self):
        ...
        if os.path.exists(mean_tree_check) and os.path.exists(mean_herb_check):
            print("Tree cover: processed tree/herb cover rasters already exist; skipping download.")
            return
        ...
        if not expected_dates:
            print("Tree cover: no VCF images found for requested period.")
            return
        ...
        print("Tree cover: missing VCF files downloaded.")
    ...
    def _preprocess_tree_cover(self):
        ...
        if not (os.path.exists(mean_tree_check) and os.path.exists(mean_herb_check)):
            ...
            print("Tree cover: processed tree/herb cover rasters already exist; skipping preprocessing.")
